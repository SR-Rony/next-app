...
export const NavbarComponent = () => {
  return (
    <Navbar className="bg-black text-white" fluid={true}>
      <div className="container grid grid-cols-12 items-center py-4">
        ...
        <div className="col-span-12 py-4 md:py-0 order-3 md:order-2 md:col-span-6">
          <div className="relative">
            <Input id="name" className="focus-visible:ring-offset-0 ring-2 ring-secoundary  focus-visible:ring-metal-0 rounded-full px-4 " placeholder="Enter name" type="text" />
